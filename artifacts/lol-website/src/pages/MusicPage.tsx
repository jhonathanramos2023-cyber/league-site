...
const MUSIC_GROUPS: Group[] = [
  {
    ...
    color: "#9B5CD4",
    members: [
      { champ: "Ahri", role: "Vocalista principal", skinNum: 15 },
      { champ: "Akali", role: "Rapera", skinNum: 9 },
      { champ: "Evelynn", role: "Vocalista", skinNum: 6 },
      { champ: "Kaisa", role: "Vocalista / Bailarina", skinNum: 14 },
    ],
    songs: [
  ...
  },
  {
    ...
    color: "#C8542A",
    members: [
      { champ: "Mordekaiser", role: "Bajo", skinNum: 3 },
      { champ: "Karthus", role: "Vocalista", skinNum: 4 },
      { champ: "Yorick", role: "Guitarra", skinNum: 2 },
      { champ: "Sona", role: "Teclados", skinNum: 2 },
      { champ: "Olaf", role: "Batería", skinNum: 4 },
      { champ: "Kayle", role: "Guitarra líder", skinNum: 9 },
    ],
    songs: [
  ...
  },
  {
    ...
    color: "#0BC4E3",
    members: [
      { champ: "Ekko", role: "MC principal", skinNum: 19 },
      { champ: "Qiyana", role: "Rapera", skinNum: 2 },
      { champ: "Senna", role: "Vocalista", skinNum: 1 },
      { champ: "Yasuo", role: "Productor / MC", skinNum: 18 },
      { champ: "Akali", role: "Rapera", skinNum: 15 },
    ],
    songs: [
  ...
  },
  {
    ...
    color: "#FF69B4",
    members: [
      { champ: "Lux", role: "Líder / Vocalista", skinNum: 6 },
      { champ: "Jinx", role: "Rebelde / Vocalista", skinNum: 4 },
      { champ: "Janna", role: "Maestra / Guía", skinNum: 7 },
      { champ: "Lulu", role: "Adorable / Soprano", skinNum: 6 },
      { champ: "Poppy", role: "Fuerte / Contralto", skinNum: 7 },
    ],
    songs: [
  ...
  },
  {
    ...
    isNew: true,
    members: [
      { champ: "Sett", role: "Vocalista principal", skinNum: 56 },
      { champ: "Yone", role: "MC / Vocalista", skinNum: 45 },
      { champ: "Kayn", role: "Rapero / MC oscuro", skinNum: 20 },
      { champ: "Aphelios", role: "Instrumentalista", skinNum: 30 },
      { champ: "Ezreal", role: "Vocalista pop", skinNum: 43 },
      { champ: "KSante", role: "Vocalista R&B", skinNum: 8 },
    ],
    songs: [
